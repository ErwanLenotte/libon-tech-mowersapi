...
import static com.libon.mowersapi.domain.InstructionEnum.D;
import static com.libon.mowersapi.domain.InstructionEnum.G;
...
import static org.assertj.core.api.AssertionsForClassTypes.assertThat;
 ...
 class MowerTest {
    ...
    void mower_from_north_should_go_west_when_direction_is_left(){
        Mower mower = new Mower("id",0,0,0,0,N);
    ...
    void mower_from_south_should_go_east_when_direction_is_left(){
        Mower mower = new Mower("id",0,0,0,0,S);
        mower.changeDirection(G);
        OrientationEnum actual = mower.getOrientation();
        assertThat(actual).isEqualTo(E);
    }
    ...
    void mower_from_west_should_go_south_when_direction_is_left(){
        Mower mower = new Mower("id",0,0,0,0,W);
        mower.changeDirection(G);
        OrientationEnum actual = mower.getOrientation();
    ...
    void mower_from_east_should_go_north_when_direction_is_left(){
        Mower mower = new Mower("id",0,0,0,0,E);
        mower.changeDirection(G);
        OrientationEnum actual = mower.getOrientation();
        assertThat(actual).isEqualTo(N);
    }
    ...
    void mower_should_advance_south(){
        Mower mower = new Mower("id",1,1,1,1,S);
        mower.advance();
    ...
    void mower_should_advance_north(){
        Mower mower = new Mower("id",1,1,0,0,N);
        mower.advance();
    ...
    void mower_should_advance_east(){
        Mower mower = new Mower("id",1,1,0,0,E);
        mower.advance();
    ...
    void mower_should_advance_west(){
        Mower mower = new Mower("id",1,1,1,1,W);
        mower.advance();
    ...
    void mower_should_not_advance_south(){
        Mower mower = new Mower("id",1,1,0,0,S);
        mower.advance();
    ...
    void mower_should_not_advance_north(){
        Mower mower = new Mower("id",1,1,1,1,N);
        mower.advance();
    ...
    void mower_should_not_advance_east(){
        Mower mower = new Mower("id",1,1,1,1,E);
        mower.advance();
    ...
    void mower_should_not_advance_west(){
        Mower mower = new Mower("id",1,1,0,0,W);
        mower.advance();
